...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String locationOfKey = context.getString(R.string.pref_location_key);
        String locationDefault = context.getString(R.string.pref_location_default);
        String preferredLocation = sharedPreferences.getString(locationOfKey,locationDefault);
    ...
    public static boolean isMetric(Context context) {
        ...
        String preferredUnits = sharedPreferences.getString(unitsKey,defaultUnits);
        String unitMetric = context.getString(R.string.pref_units_metric);
        boolean usersPreference;
        if (unitMetric.equals(preferredUnits)) {
                usersPreference = true;
        } else {
            usersPreference = false;
        }
