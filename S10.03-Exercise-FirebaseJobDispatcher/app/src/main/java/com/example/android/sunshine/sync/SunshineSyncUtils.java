...
public class SunshineSyncUtils {
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        Job syncSunshineJob = dispatcher.newJobBuilder().setService(SunshineFirebaseJobService.class).setTag(SUNSHINE_SYNC_TAG)
                .setConstraints(Constraint.ON_ANY_NETWORK).setLifetime(Lifetime.FOREVER).setRecurring(true).setTrigger(Trigger.executionWindow(
