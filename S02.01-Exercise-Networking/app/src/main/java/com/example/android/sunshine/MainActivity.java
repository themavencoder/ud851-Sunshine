...
public class MainActivity extends AppCompatActivity {
    ...
    public class NetworkRequest extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            URL urlweather = NetworkUtils.buildUrl(place);

            try {
                String responseFromWeather = NetworkUtils.getResponseFromHttpUrl(urlweather);
                String[] weatherDetails = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,responseFromWeather);
        ...
        @Override
        protected void onPostExecute(String[] weatherInformation) {
            if (weatherInformation != null) {
                for (String weatherinfo : weatherInformation) {
