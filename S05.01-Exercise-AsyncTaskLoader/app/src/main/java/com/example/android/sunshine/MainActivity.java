...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id_loader = LOADER_ID;
        LoaderManager.LoaderCallbacks<String[]> callback = MainActivity.this;
        Bundle bundleForLoader = null;
        getSupportLoaderManager().initLoader(id_loader, bundleForLoader, callback);
    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                URL requestForWeather = NetworkUtils.buildUrl(location);

                try {
                    String jsonWeatherResponse = NetworkUtils
                            .getResponseFromHttpUrl(requestForWeather);

                    String[] weatherDataJson = OpenWeatherJsonUtils
